...
大家都在蒸馏同事、老板、前任。我们想蒸的不是某一个人，**是整个组织。**

你可能也有过这种感觉：老板像是在找一个能替代你的人；有的人天天在拍板，其实根本没决定权；一个需求传三轮，意思就全变了。很多时候，问题不是某个人有毒，而是**组织本身就没说明白自己怎么运转。**

这个项目就是干这个的：把群聊、会议、任务分派、交接材料这些工作痕迹整理起来，蒸成一份 Agent 能继续用的**组织画像**。它不做性格测试，也不装懂办公室政治。它只想帮你看清几件事：谁手里有上下文，谁在传话，谁在缓冲，谁看起来像 owner，其实拍不了板。
...
但打工久了你会发现，真正折磨人的，往往不是某一个人，而是**整个组织拧巴。** 你明明感觉不对，却说不清到底卡在哪。这个仓库想做的，就是把这种说不清的感觉拆开：到底是谁拿着上下文，信息是从哪一层开始跑偏的，谁一直在当传话筒，谁看起来在负责、其实根本拍不了板。最后你拿到的，不是情绪发泄，而是一张更接近真实情况的组织关系图。
