...
大家都在做“同事 Skill”“老板 Skill”“办公室人格分析器”，但我们更想做一件反过来的事：**不是分析一个人，而是反向蒸馏一个组织。**

我们想知道的，不是谁天生难搞，而是谁在掌握上下文，谁在转述失真，谁在承担缓冲，谁看起来像 owner、其实并没有拍板权。这个项目就是把群聊、会议、任务分派和用户自述这些日常工作痕迹，重新翻译成**可供 Agent 使用的组织分析骨架**。

它不是一个给同事贴标签的玩具，也不是一个读几段聊天就下结论的算命器。更准确地说，**这是一个面向组织诊断场景的开源 Skill 原型**：它把零散工作痕迹整理成结构化证据、中间分析结果和可复用的诊断输出，方便开发者继续封装成自己的 Agent、工作流或产品。
...
很多“职场分析”产品最后都会落回对个人性格的判断：这个人是不是难搞，那个老板是不是控制欲太强，某个同事是不是情商低。但真实工作现场里，问题往往不只属于某个人，而属于一个**协作结构**。

这个仓库要做的，是把“我感觉这团队哪里不对劲”拆成几类更可验证的问题：信息在哪一层被折损，谁在承担隐形翻译成本，谁在做缓冲，谁在组织里承担 owner 预期却没有真正拍板权，以及你面前看到的是执行问题，还是结构问题。
